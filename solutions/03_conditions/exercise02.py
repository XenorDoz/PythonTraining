...
"""
If price is above or equal to 100, apply a reduction of 10 %
Otherwise, if price is above or equal to 50, apply a reduction of 5
Otherwise, if price is above or equal to 20, apply a reduction of 1
